            ...
            <mu-col width="100" tablet="50" desktop="50">
              <div>
                ...
                <div class="discription">
                  ...
                  <div class="place">
                  ｜講座｜<br/>
                  時間：03.29、 05.08｜19：00 - 21：00<br/>
                  地點：新生教學館 203 教室<br/>
                  ｜工作坊｜<br/>
                  時間：04.01｜09:00 - 16:00<br/>
                  地點：第二學生活動中心<br/>
                  ｜攝影展｜<br/>
                  時間：05.05 - 05.26｜09：00 - 18：00<br/>
                  地點：醉月湖旁草地<br/>
                  ｜紀實文字作品｜<br/>
                  時間：05.09 - 05.26｜00：00 - 23：59<br/>
                  地點：臺大藝術季網站<br/>
                  </div>
                </div>
              </div>
            ...
            <mu-col width="100" tablet="50" desktop="50">
              <div>
                ...
                <div class="discription">
                  ...
                  <div class="place">
                 ｜影展｜<br/>
                  時間：05.08 - 05.12｜18：30 - 21：30  <br/>
                  地點： 第一學生活動中心 104<br/>
                  ｜常設展｜<br/>
                  時間：05.08 - 05.12｜10：00 - 18：00  <br/>
                  地點： 第一學生活動中心 104
                  </div>
                </div>
              </div>
        ...
        <div class="project">
          <mu-row gutter>
            <mu-col width="100" tablet="50" desktop="50">
              <div
              class="project-img"
              :style="{ 'background-image': 'url(' + retro + ')' }"
              >
              </div>
            </mu-col>
            <mu-col width="100" tablet="50" desktop="50">
              <div>
                <div class="title">溯</div>
                <div class="discription">
                  <div>
                  我們早已習慣選舉將近時飄揚著各式候選人宣傳旗幟的街道，自由民主這個詞彙如同空氣一般自然地嵌融在我們的生活裡，我們與它共存，卻鮮少凝視它的過去。 民主自由並非自然而然地發生，先人用血與眼淚為我們引路，帶領我們走向開放的民主社會。
                  </div>
                  <br/>
                  <div>
                  因此，《溯》要與大家一同回首，凝視先人、凝視歷史、凝視傷疤。 我們嘗試用另一種面貌來呈現轉型正義。透過仿照歷史現場的裝置物件，還原過去權威時期的時空背景，我們期待與你一起在不同的裝置作品中反思過去，深入探究在這片土地上發生過的世代記憶。
                  </div>
                  <div class="place">
                  ｜裝置作品｜<br/>
                  時間：05.08 - 05.28｜09：00 - 18：00 <br/>
                  地點：博雅草坪、文學院前、社科草坪、陳文成廣場<br/>
                  ｜校園導覽｜<br/>
